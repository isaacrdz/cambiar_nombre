...
export const translateHistory = (string) => {
  ...
  string = string.replace(
    "Client has visited the store. Qr Code scanned by",
    "Cliente ha visitado la agencia. Código Qr escaneado por"
  );
  ...
  string = string.replace(
    "has change the status to success",
    "has change the status to success"
  );
